        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-gray-900">{{$specialist->id}}</div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 h-10 w-10">
                            <img class="h-10 w-10 rounded-full" src="{{$specialist->img}}" alt="">
                        </div>
                    </div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-gray-900">{{$specialist->surname . ' ' . $specialist->name}}</div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-gray-900">{{$specialist->cab}}</div>
                </td>
                @if($specialist->specialist && $specialist->specialist->specialty)
                    <td class="px-12 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900">{{ json_decode('"'.$specialist->specialist->specialty->title.'"') }}</div>
                    </td>
                @else
                    <td class="px-12 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900">Нет</div>
                    </td>
                @endif
                <td class="px-6 py-4 whitespace-nowrap  text-sm font-medium">
                    <a href="{{route('demote-to-user', $specialist->id)}}" class="ml-2 text-red-600 hover:text-red-900">Demote to user</a>
                </td>
            </tr>
            @endforeach
        </tbody>
